...
{
    internal class ManagementKeycard : Keycard
    {
        public string Label { get; }
        public Color TextColor { get; }

        public ManagementKeycard(string id, string itemName, int containment, int armory, int admin, Color primaryColor, Color permsColor, string label, Color textColor)
        ...
        {
            var card = KeycardItem.CreateCustomKeycardManagement(
                target,
                ItemName,
                Label,
                Access,
        ...
        internal new static Keycard Parse(string id, Dictionary<string, string> properties)
        {
            ...
            return new ManagementKeycard(id, itemName, containment, armory, admin, primaryColor, permsColor, label, textColor);
        }
    }
}