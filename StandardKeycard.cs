...
{
    internal class StandardKeycard : Keycard
    {
        ...
        public StandardKeycard(string id, string itemName, int containment, int armory, int admin, Color primaryColor, Color permsColor, string ownerNameFormat, string label, Color textColor, byte wearLevel)
        ...
        {
            var card = KeycardItem.CreateCustomKeycardSite02(
                target,
                ItemName,
        ...
        internal new static Keycard Parse(string id, Dictionary<string, string> properties)
        {
            ...
            return new StandardKeycard(id, itemName, containment, armory, admin, primaryColor, permsColor, ownerNameFormat, label, textColor, wearLevel);
        }
    }
}